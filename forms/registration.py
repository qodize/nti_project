...
"font-size: 19px;}")
        ...
        self.gender_line = QtWidgets.QLineEdit(self.formLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gender_line.sizePolicy().hasHeightForWidth())
        self.gender_line.setSizePolicy(sizePolicy)
        self.gender_line.setObjectName("gender_line")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.gender_line)
        ...
        self.registration2_btn = QtWidgets.QPushButton(Form)
        self.registration2_btn.setGeometry(QtCore.QRect(150, 300, 241, 44))
        self.registration2_btn.setStyleSheet("QPushButton {font-family:Yu Gothic UI ;\n"
"                    font-size: 20px;\n"
...
"}")
        self.registration2_btn.setObjectName("registration2_btn")
    ...
    def retranslateUi(self, Form):
        ...
        self.registration2_btn.setText(_translate("Form", "Зарегистрироваться"))
